    ...
    <button class="centerColumn" type="submit">Tester</button>
        <fieldset class="leftColumn" >
            ...
            <label class="labelPokemon"> 
                <input type="radio" name="pokemon" value="<?= $pokemon->getId(); ?>" required>
                <img class="pokemonImg" src='<?= $pokemon->getPokemonImg() ?>' alt='<?= $pokemon->getPokemonName() ?>'>
        ...
        <fieldset class="rightColumn" required>
            ...
            <label class="labelPokemon ">
                <input type="radio" name="vspokemon" value="<?= $pokemon->getId(); ?>" required>
                <img class="pokemonImg" src='<?= $pokemon->getPokemonImg() ?>' alt='<?= $pokemon->getPokemonName() ?>'>
                <p><?= $pokemon->getPokemonName(); ?></p>
                <ul>
                    <li><img src='<?= $pokemon->getType1()->getTypeImg() ?>'>
